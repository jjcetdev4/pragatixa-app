...
public class StudentTeamDetailsResponse {
    ...
    public String getViceCaptainName() { return viceCaptainName; }
    public void setViceCaptainName(String viceCaptainName) { this.viceCaptainName = viceCaptainName; }

    public String getCurrentStudentRole() { return currentStudentRole; }
    public void setCurrentStudentRole(String currentStudentRole) { this.currentStudentRole = currentStudentRole; }

    public int getTotalTeamXp() { return totalTeamXp; }
    public void setTotalTeamXp(int totalTeamXp) { this.totalTeamXp = totalTeamXp; }
    ...
    public List<TeamMemberRankDto> getMembers() { return members; }
    public void setMembers(List<TeamMemberRankDto> members) { this.members = members; }
}
