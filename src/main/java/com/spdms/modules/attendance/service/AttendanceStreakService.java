...
public class AttendanceStreakService {
    ...
    public void updateAttendanceStreak(Student student, LocalDate date) {
        ...
        long presentCount = attendanceRepository.countByStudentIdAndAttendanceDateAndStatus(student.getId(), date, Attendance.AttendanceStatus.PRESENT);
        
        Optional<Streak> existingStreak = streakRepository.findByStudentRegNoAndStreakType(student.getRegNo(), "ATTENDANCE");
