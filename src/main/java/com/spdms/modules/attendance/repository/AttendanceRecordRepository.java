...
public interface AttendanceRecordRepository extends JpaRepository<AttendanceRecord, Long> {
    ...
    long countPresentBySessionDetails(@Param("date") LocalDate date, @Param("period") Integer period, @Param("yearId") Long yearId, @Param("deptId") Long deptId, @Param("sectionId") Long sectionId);
    ...
    long countAbsentBySessionDetails(@Param("date") LocalDate date, @Param("period") Integer period, @Param("yearId") Long yearId, @Param("deptId") Long deptId, @Param("sectionId") Long sectionId);
    ...
    List<AttendanceRecord> findBySessionDetailsAndStatus(@Param("date") LocalDate date, @Param("period") Integer period, @Param("yearId") Long yearId, @Param("deptId") Long deptId, @Param("sectionId") Long sectionId, @Param("status") AttendanceRecord.AttendanceStatus status);
    ...
    long countPresentByStudentIdAndMonth(@Param("studentId") Long studentId, @Param("month") int month, @Param("year") int year);
    ...
    long countAbsentByStudentIdAndMonth(@Param("studentId") Long studentId, @Param("month") int month, @Param("year") int year);
    
    // For streak calculations: need to check if a student was fully present on specific dates
