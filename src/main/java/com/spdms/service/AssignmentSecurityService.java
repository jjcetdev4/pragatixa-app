...
public class AssignmentSecurityService {
    ...
    /**
     * Determines whether the given User is the assigned faculty for the given ActivityAssignment.
    ...
    public boolean isUserAssignedFaculty(ActivityAssignment assignment, User user) {
        ...
        if (assignment.getAssignmentScope() == AssignmentScope.DEPARTMENT || assignment.getAssignmentScope() == AssignmentScope.SECTION) {
            ...
            if (assignment.getDepartment() != null && assignment.getSection() != null) {
                ...
                // If the logged-in user is one of the resolved CCs for this specific dept/sec, they are authorized
