...
public class Streak {
    ...
    public int getPenaltyPerBreak() { return penaltyPerBreak; }
    public void setPenaltyPerBreak(int penaltyPerBreak) { this.penaltyPerBreak = penaltyPerBreak; }
    ...
    public static class Builder {
        ...
        public Builder isBroken(boolean v) { s.isBroken = v; return this; }
        public Builder penaltyPerBreak(int v) { s.penaltyPerBreak = v; return this; }
        public Streak build() { return s; }
    }
}
