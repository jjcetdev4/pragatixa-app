...
public class TempDebugController {
    ...
    public TempDebugController(ActivityRepository activityRepository,
            ActivityStageMappingRepository mappingRepository) {
    ...
    public String debug() {
        ...
        for (Activity a : activities) {
            ...
            sb.append("Subgroup Name : ").append(a.getSubgroup() != null ? a.getSubgroup().getName() : "null")
                    .append("\n");
            sb.append("Category : ").append(a.getSubgroup() != null ? a.getSubgroup().getCategory() : "null")
                    .append("\n");
            ...
            for (ActivityStageMapping m : mappings) {
                ...
                sb.append("subgroup_id : ").append(m.getSubgroup() != null ? m.getSubgroup().getId() : "null")
                        .append("\n");
                sb.append("subgroup_name : ").append(m.getSubgroup() != null ? m.getSubgroup().getName() : "null")
                        .append("\n");
                sb.append("subgroup_category : ")
                        .append(m.getSubgroup() != null ? m.getSubgroup().getCategory() : "null").append("\n\n");
            }
        }
