package jjcet.PragatiX.modules.analytics.service.xp;

import jjcet.PragatiX.entity.User;
import jjcet.PragatiX.modules.analytics.dto.*;
import jjcet.PragatiX.modules.analytics.repository.xp.XpAnalyticsRepository;
...
// Legacy implementation superseded by domain.service.xp.XpAnalyticsService
// @Service
public class XpAnalyticsService {
    ...
    public List<jjcet.PragatiX.modules.analytics.dto.XpDistributionDto> getXpDistribution(String yearNo) {
        return xpAnalyticsRepository.getXpDistribution(yearNo);
    }

    public List<jjcet.PragatiX.modules.analytics.dto.DepartmentXpAttendanceDto> getMonthlyAvgXpByDepartment(String yearNo) {
        return xpAnalyticsRepository.getMonthlyAvgXpByDepartment(yearNo);
    }

    public List<jjcet.PragatiX.modules.analytics.dto.DepartmentXpAttendanceDto> getAllTimeAvgXpByDepartment(String yearNo) {
        return xpAnalyticsRepository.getAllTimeAvgXpByDepartment(yearNo);
    }

    public List<jjcet.PragatiX.modules.analytics.dto.TopPerformerDto> getTopPerformersNew(String yearNo, int limit) {
        return xpAnalyticsRepository.getTopPerformersNew(yearNo, limit);
    }

    public List<jjcet.PragatiX.modules.analytics.dto.EliteTeamDto> getTopEliteTeams(String yearNo, int limit) {
        return xpAnalyticsRepository.getTopEliteTeams(yearNo, limit);
    }

    public jjcet.PragatiX.modules.analytics.dto.AllInOneDashboardDto getDashboardSummary(String yearNo) {
        return xpAnalyticsRepository.getDashboardSummary(yearNo);
    }
}
